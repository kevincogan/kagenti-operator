...
// When identity binding is configured, both signature AND binding must pass for a
// permissive policy. This aligns with the label propagation logic in AgentCardReconciler
// where the signature-verified label requires both checks to pass.
