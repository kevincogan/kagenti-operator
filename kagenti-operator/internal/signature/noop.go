...
func (p *NoOpProvider) VerifySignature(ctx context.Context, cardData *agentv1alpha1.AgentCardData, signature *agentv1alpha1.CardSignature) (*VerificationResult, error) {
